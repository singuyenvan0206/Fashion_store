...
namespace WpfApp1
{
    ...
    {
        public string PaymentMethod { get; set; } = "momo"; // "momo", "zalopay", "bank"
        public string MoMoPhone { get; set; } = "0901234567";
        public string ZaloPayPhone { get; set; } = "0901234567";
        public string BankAccount { get; set; } = "1234567890";
        public string BankName { get; set; } = "Ngân hàng ABC";
        public string AccountName { get; set; } = "Công ty TNHH ABC";
